...
//             GameObject instance = AssetLoader.Instantiate(ui, true);
...
//             else
//             {
//                 Debug.LogError($"Failed to open, possibly with wrong path or resource not loaded: {ui}. (打开失败，可能路径错误或资源未加载：{ui})");
//                 return null;
//             }
//         }
...
//                 if (destroy)
//                 {
//                     AssetLoader.ReleaseResource(ui);
//                     Destroy(instance);
