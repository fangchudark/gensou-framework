...
namespace GensouLib.GenScript.Interpreters
{
    ...
    public class ConditionInterpreter : BaseInterpreter
    {
        /// <summary> 
        /// 处理条件命令 <br/>
        /// Processes condition commands 
        /// </summary>
        /// <param name="condition"> 
        /// 条件表达式，表示需要评估的逻辑条件。<br/>
        /// A condition expression that represents the logical condition to be evaluated. 
        /// </param>
        /// <returns> 
        /// 条件的结果，返回布尔值指示条件是否满足。<br/>
        /// The result of the condition, returning a boolean value indicating whether the condition is met. 
        /// </returns>
